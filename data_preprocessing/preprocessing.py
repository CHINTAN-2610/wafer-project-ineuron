...
class Preprocessor:
    ...
    def drop_duplicate(self, data):
        ...
        Method Name: impute_missing_values
                                        Description: This method remove all duplicates records from database before training model which
                                        might be added while database operation.
                                        On Failure: Raise Exception
        ...
        """
        self.logger_object.log(self.file_object, 'Entered the duplicate present method of the Preprocessor class')
        try:
            self.data = data
            self.new_data = self.data.drop_duplicates()
            self.logger_object.log(self.file_object,'Dropping duplicate record is successfull.')
            return self.new_data

        except Exception as e:
            self.logger_object.log(self.file_object, "Exception occur while duplicate record removal" + str(e))
            self.logger_object.log(self.file_object, "Dropping Duplicate failed")
            raise Exception()
